...
LAST_UPDATED  = 2026-04-21 14:14:03
```
...
```text
OBSERVATION_WINDOW: up to 2026-04-21 14:14:03
TOTAL_SIGNALS: 430
...
BLOCKED_REASON_DISTRIBUTION: DAILY_LOSS_LIMIT=6, no_ranked_signal{all_filtered=165, legacy=25}
