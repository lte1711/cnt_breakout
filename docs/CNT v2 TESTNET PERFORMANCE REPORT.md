...
LAST_UPDATED  = 2026-04-21 13:54:02
```
...
```text
OBSERVATION_WINDOW: up to 2026-04-21 13:54:02
TOTAL_SIGNALS: 426
TOTAL_SELECTED_SIGNALS: 25
...
BLOCKED_REASON_DISTRIBUTION: DAILY_LOSS_LIMIT=6, no_ranked_signal{all_filtered=163, legacy=25}
RISK_TRIGGER_STATS: DAILY_LOSS_LIMIT=12
...
SELECTION_LOG_COUNTS: breakout_v1=2, pullback_v1=18
