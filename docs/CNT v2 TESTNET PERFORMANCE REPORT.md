...
LAST_UPDATED  = 2026-04-21 13:04:03
```
...
```text
OBSERVATION_WINDOW: up to 2026-04-21 13:04:03
TOTAL_SIGNALS: 416
...
BLOCKED_REASON_DISTRIBUTION: DAILY_LOSS_LIMIT=3, no_ranked_signal{all_filtered=161, legacy=25}
